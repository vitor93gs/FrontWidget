...
export function Sucesso({ onFeedbackRestart }: Props) {
	return (
		<>
			<header>
				<CloseButton />
			...
			<div className="flex flex-col items-center py-10 w-[304px]">
				...
				<button
					...
					className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:border-red-700 focus:ring-red-700 focus:ring-2 resize-none focus:outline-none"
				>
					Quero enviar outro
				</button>
			</div>
